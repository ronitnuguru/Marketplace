...
<p>Partners's App is a CRM suite designed for life sciences...</p>
...
<ul>
    <li><b>Partners App</b> enhances customer engagement in life sciences.</li>
</ul>

<h3><b>Call to Action</b></h3>
<p>Learn more at <a href="https://www.parnter.com">Parnters's website</a>.</p>
...
`;
    ...
    templatePrompts = [{
            label: "What is Parnter...",
            icon: "utility:search"
        },
        {
            label: "How to setup Partner and Salesforce...",
            icon: "utility:integration"
        },
        {
            label: "Find documentation for Parnter's integration...",
